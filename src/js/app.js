...
(function () {
            ...
            Array.from(flatpickrExamples).forEach(function (item) {
                if (item.getAttribute("data-provider") == "flatpickr") {
                    ...
                    if (isFlatpickerVal["data-altFormat"]) {
                        (dateData.altInput = true), (dateData.altFormat = isFlatpickerVal["data-altFormat"].value.toString());
                    }
                    ...
                    if (isFlatpickerVal["data-inline-date"]) {
                        (dateData.inline = true), (dateData.defaultDate = isFlatpickerVal["data-deafult-date"].value.toString());
                        dateData.dateFormat = isFlatpickerVal["data-date-format"].value.toString();
                    }
    ...
    function initLeftMenuCollapse() {
        ...
        if (document.documentElement.getAttribute("data-layout") == "vertical" || document.documentElement.getAttribute("data-layout") == "semibox") {
            if (document.getElementById("two-column-menu") !== null) {
                document.getElementById("two-column-menu").innerHTML = "";
            }
            if (document.querySelector(".navbar-menu")) {
                document.querySelector(".navbar-menu").innerHTML = navbarMenuHTML;
            }
            (document.getElementById("scrollbar")) ? document.getElementById("scrollbar").setAttribute("data-simplebar", "") : "";
            (document.getElementById("navbar-nav")) ? document.getElementById("navbar-nav").setAttribute("data-simplebar", "") : "";
            (document.getElementById("scrollbar")) ? document.getElementById("scrollbar").classList.add("h-100") : "";
        }
        ...
        if (document.documentElement.getAttribute("data-layout") == "twocolumn") {
            document.getElementById("scrollbar") ? document.getElementById("scrollbar").removeAttribute("data-simplebar") : "";
            document.getElementById("scrollbar") ? document.getElementById("scrollbar").classList.remove("h-100") : "";
        }
        ...
        if (verticalOverlay) {
            Array.from(verticalOverlay).forEach(function (element) {
                element.addEventListener("click", function () {
                    ...
                    if (sessionStorage.getItem("data-layout") == "twocolumn") document.body.classList.add("twocolumn-panel");
                    else document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size"));
                });
            });
        }
    }
    ...
    function windowLoadContent() {
        ...
        document.getElementById("topnav-hamburger-icon") ? document.getElementById("topnav-hamburger-icon").addEventListener("click", toggleHamburgerMenu) : "";
